from csv import DictReader, DictWriter, list_dialects, QUOTE_NONE, register_dialect
from os.path import basename, dirname, join
from threading import Thread
from time import sleep
from datetime import timedelta, time

from tkinter import Button, Frame, Label, StringVar, Tk, Toplevel, Text, Scrollbar
...
CODECS: set = {'ascii', 'big5', 'big5hkscs', 'cp037', 'cp273', 'cp424', 'cp437', 'cp500', 'cp720', 'cp737', 'cp775',
...
EXTENSOES: list[tuple[str, str]] = [('Arquivos CSV', '*.csv')]

NOME_PARTICIPANTE: str = 'Nome completo'

STRING_COLUNA_CPF: str = 'CPF (sem pontos e traço ex: 12345678900)'
